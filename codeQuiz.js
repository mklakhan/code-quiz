...
const GameQuestions = [
    {
        questions: {
            Question: 'What was the name of the pre-Saved by the Bell series that featured Zack, Screech, and Lisa?',
            Answers: ['Mr. Beldings\'s World', 'Life from Bayside High', 'Good Morning Miss Bliss', 'High School Never Ends'],
    ...
    },
    {
        questions: {
            ...
            Answers: ['Bulldogs', 'Tigers', 'Lions', 'Baysiders'],
            correct: 'Bulldogs'
        }
    },
    {
        questions: {
            Question: 'Who received the highest score on the SAT?',
            Answers: ['Kelly', 'Zack', 'Screech', 'Slater', 'Jessie', 'Lisa'],
            correct: 'Zack'
        }
    },
    {
        questions: {
            ...
            Answers: ['Albert Clifford Slater', 'Alexander Carl Slater', 'Andres Caleb Slater', 'Awesome and Charming Slater'],
    ...
    },
    {
        questions: {
            ...
            Answers: ['Slater', 'Johnny Dakota', 'Screech', 'Jeffrey Hunter'],
            correct: 'Jeffrey Hunter'
        }
    },
    {
        questions: {
            Question: 'What did Zack always say before the show froze and he analyzed the situation around him?',
            Answers: ['Freeze!', 'Time Out!', 'Hold up!', 'Pause!'],
            correct: 'Time Out!'
        }
    },
    {
        questions: {
            ...
            Answers: ['Stanford', 'Oxford', 'UCLA', 'Cal U'],
            correct: 'Cal U'
        }
    },
    {
        questions: {
            Question: 'What\'s the name of the beach club were Zack falls in love with Stacey Carosi?',
            Answers: ['North Beach Club', 'California Beach Club', 'Bayside Beach Club', 'Malibu Sands Beach Club'],
    ...
    },
    {
        questions: {
            ...
            Answers: ['1966 Mustang', '1969 Dodge Charger', '1963 Corvette Stingray', '1966 Shelby Cobra'],
